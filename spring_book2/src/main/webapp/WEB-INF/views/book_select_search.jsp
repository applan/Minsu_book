		...
		<div class="row">
			<div class="col-xl-3">
				<div class="list-group" id="myList" role="tablist">
				    ...
				    <a href="#search2" role="tab" data-toggle="list" class="list-group-item list-group-item-action">도서 검색한 결과</a>
				</div>
			</div>
			<div class="col-xl-9">
				<div class="tab-content" id="nav-tabContent">
					<div class="tab-pane fade" role="tabpanel" id="search2">
...
<script>
	$(function(){
		$("document").ready(function(){ 
			$("#myList a[href='#search2']").tab("show");
